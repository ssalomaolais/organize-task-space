...
export const SemesterView = ({ role, showCardContent, filteredTasks, selectedYear, setEditingTask, handleDeleteTask, handleStatusChange, handleTypeChange }: SemesterViewProps) => {
